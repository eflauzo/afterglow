...
import { CxRenderingProgramColorArray } from './rendering_program_color_array'
...
export class CxVisualizerColorArray extends CxVisualizer {
    ...
    visualize(context: CxRenderingContext, program_param:CxRenderingProgram): void {
        var program:CxRenderingProgramColorArray = <CxRenderingProgramColorArray>program_param
